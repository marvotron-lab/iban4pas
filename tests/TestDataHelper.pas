...
type
    TIbanStr = TPair<IIban, string>;
    TIbanStrList = TList<TIbanStr>;

    TTestDataHelper = class
    private
        class var FIbanData: TIbanStrList;
    public
        const BIC_DATA: array [0..6] of string =
                (('DEUTDEFF'),
                ('DEUTDEFF500'),
                ('NEDSZAJJXXX'),
                ('DABADKKK'),
                ...
                ('DSBACNBXSHA'),
                ('BNORPHMM'));
        class function getIbanData(): TIbanStrList;
    end;
...
class function TTestDataHelper.getIbanData(): TIbanStrList;
begin
    if not Assigned(FIbanData) then
    begin
        FIbanData := TIbanStrList.Create();
        FIbanData.Add(TIbanStr.Create(TIban.Builder()
        ...
        FIbanData.Add(TIbanStr.Create(TIban.Builder()
                .countryCode(TCountryCode.FI)
                .bankCode('123456')
                .accountNumber('0000078')
                .nationalCheckDigit('5')
                .build(), 'FI2112345600000785'));
        FIbanData.Add(TIbanStr.Create(TIban.Builder()
                .countryCode(TCountryCode.FR)
                .bankCode('20041')
                .branchCode('01005')
